...
import (
	...
	repo "eigen-backend-test-case/features/members/repository"
...
var serviceTest members.ServiceInterface
...
func TestMain(m *testing.M) {
	...
	repoTest := repo.NewMembersRepository(db, ctx)

	serviceTest = NewMembersService(repoTest, ctx)
...
func TestListMembersWithBorrowedAmount(t *testing.T) {
	...
	for _, v := range tests {
		t.Run(v.name, func(t *testing.T) {
			res, err := serviceTest.ListMembersWithBorrowedAmount()
			if !v.err {
