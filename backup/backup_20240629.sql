...
1	JK-45	Harry Potter	J.K Rowling	1	\N
2	SHR-1	A Study in Scarlet	Arthur Conan Doyle	1	\N
3	TW-11	Twilight	Stephenie Meyer	1	\N
4	HOB-83	The Hobbit, or There and Back Again	J.R.R. Tolkien	1	\N
5	NRN-7	The Lion, the Witch and the Wardrobe	C.S. Lewis	1	\N
7	ACD-02	Sherlock Holmes Chapter 2	Sir Arthur Conan Doyle	7	\N
8	ACD-03	Sherlock Holmes Chapter 3	Sir Arthur Conan Doyle	13	\N
6	ACD-01	Sherlock Holmes Chapter 1	Sir Arthur Conan Doyle	4	\N
\.
...
SELECT pg_catalog.setval('public.borrowed_books_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.penalized_members_id_seq', 1, false);
