...
CREATE TABLE public.penalized_members (
    id integer NOT NULL,
    member_id integer NOT NULL,
    penalty_start timestamp without time zone NOT NULL,
...
6	ACD-01	Sherlock Holmes Chapter 1	Sir Arthur Conan Doyle	3
7	ACD-02	Sherlock Holmes Chapter 2	Sir Arthur Conan Doyle	7
8	ACD-03	Sherlock Holmes Chapter 3	Sir Arthur Conan Doyle	14
\.
